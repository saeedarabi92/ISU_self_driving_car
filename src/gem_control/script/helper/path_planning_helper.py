...
#    Updated: 2021/03/22 17:12:45 by saeed            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
class RRTStarDubins(RRTStar):
    ...
    class Node(RRTStar.Node):
        ...
        def __init__(self, x, y, yaw):
            super(RRTStarDubins.Node, self).__init__(x, y)
            self.yaw = yaw
            self.path_yaw = []
    def __init__(self, start, goal, obstacle_list, rand_area,
        ...
        self.obstacle_list = obstacle_list
        self.connect_circle_dist = connect_circle_dist
        self.curvature = 1/3.0  # for dubins path
    ...
    def steer(self, from_node, to_node):
        ...
        px, py, pyaw, mode, course_length = dubins_path_planning(
    ...
    def calc_new_cost(self, from_node, to_node):
        ...
        _, _, _, _, course_length = dubins_path_planning(
            from_node.x, from_node.y, from_node.yaw,
            to_node.x, to_node.y, to_node.yaw, self.curvature)
    ...
    def get_path_info(self):
        return [(i, j, 0., 0.) for i, j in self.planning()][::-1]
...
def dubins_path_planning(s_x, s_y, s_yaw, g_x, g_y, g_yaw, c, step_size=0.1):
    ...
    le_xy = (np.stack([g_x, g_y]).T).dot(l_rot)
    le_yaw = g_yaw - s_yaw
    ...
    converted_xy = (np.stack([lp_x, lp_y]).T).dot(rot)
